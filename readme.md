...
### Дефиниране на компоненти
След като имаме механизъм за създаване и 'запазване' на данни, следва да започне и работата по потребителския интерфейс.
До завършването на експеримента ще се работи предимно с Github Copilot.

## Заключение

От направените опити до момента, може да се заключи, че Github Copilot е в състояние да генерира код, който да е базиран както на контекста на текущия проект, така и на хилядите хранилища, с които Github разполага . Едно важно предимство на Copilot пред ChatGPT е, че при използването на първия, разработчика остава предимно в интегрираната среда на разработка. Не е нужно копирането на код между чат и редактор. Това, освен че прави работата по-бърза и по-ефективна, дава възможност за по-добра интеграция със съществуващите инструменти за разработка.
